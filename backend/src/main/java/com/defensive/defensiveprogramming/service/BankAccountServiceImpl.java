...
public class BankAccountServiceImpl implements BankAccountService {
    ...
    public ResponseEntity<?> depositMoney(DepositRequest depositRequest, Authentication principal) {

        BankClient bankClient1 = (BankClient) principal.getPrincipal();

        System.out.println(bankClient1.getBankAccNumber());
