...
public class BankAccountControllerImpl{
    ...
    @PostMapping("/deposit")
    public ResponseEntity<?> depositMoney(@RequestBody @Valid DepositRequest depositRequest, Authentication principal){
        return  bankAccountService.depositMoney(depositRequest, principal);
    }
